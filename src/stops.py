...
with gtfs:
    ...
    class LocationTypeDatatype(Datatype):
        equivalent_to = [
            OneOf(
                [
                    0,
    ...
    class LocationTypeDatatypeDescription(Thing):
        pass
    ...
    class StopLocation(LocationTypeDatatypeDescription):
        comment = "A location where passengers board or disembark from a transit vehicle."

    class Platform(LocationTypeDatatypeDescription):
    ...
    class Station(LocationTypeDatatypeDescription):
        comment = "A physical structure or area that contains one or more platform."

    class EntranceOrExit(LocationTypeDatatypeDescription):
    ...
    class GenericNode(LocationTypeDatatypeDescription):
    ...
    class BoardingArea(LocationTypeDatatypeDescription):
