...
with gtfs:
    ...
    class StopTimeRequiresArrivalTime(Requirement):
        is_a = [
            arrival_time.exactly(1)
        ]

    class StopTimeFirst(StopTimeRequiresArrivalTime):
        is_a = [
            arrival_time.exactly(1)
        ]

    class StopTimeLast(StopTimeRequiresArrivalTime):
        is_a = [
            arrival_time.exactly(1)
        ]

    class ApproximateStopTime(StopTime):
